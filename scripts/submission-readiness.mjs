...
export function formatSubmissionReadinessMarkdown(packet) {
  return [
    ...
    "",
    "Brief explanation:",
    "SettleLine is a verifiable World Cup prediction settlement and trading-agent dashboard built on TxLINE-shaped data. It turns replayed match updates into deterministic market resolution, proof receipts, SHA-256 receipt hashes, verification checks, explainable LineSignal risk summaries, and a replay-only mock escrow release without requiring real-money wagering, custody, login, payment, or wallet connection for judge review.",
    "",
    "## Evidence",
    "",
